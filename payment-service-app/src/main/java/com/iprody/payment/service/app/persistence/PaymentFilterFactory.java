...
public final class PaymentFilterFactory {
    ...
    public static Specification<Payment> fromFilter(PaymentFilter filter) {
        ...
        if (filter.minAmount() != null) {
            spec = spec.and(PaymentSpecifications.amountGreater(filter.minAmount()));
        }
        if (filter.maxAmount() != null) {
            spec = spec.and(PaymentSpecifications.amountLess(filter.maxAmount()));
        }

        if (filter.createdAfter() != null) {
            spec = spec.and(PaymentSpecifications.createdGreater(filter.createdAfter()));
        }
        if (filter.createdBefore() != null) {
            spec = spec.and(PaymentSpecifications.createdLess(filter.createdBefore()));
        }
